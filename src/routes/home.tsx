    ...
    <div className="h-100">
      ...
      <Container className="d-flex h-100">
        ...
        >
          <Nav.Link
            href="/"
            className="d-flex justify-content-center align-items-center btn btn-light text-dark rounded-circle"
          ...
          <hr />
          <Nav className="nav-pills flex-column gap-3 mb-auto fs-5">
            <Nav.Item>
              <Nav.Link
                href="#"
