...
export interface ModifyReplyErrorModalProps {
  error: string;
  showModifyReplyErrorModal: boolean;
  handleCloseModifyReplyErrorModal: () => void;
}

export default function ModifyReplyErrorModal({
  error,
  showModifyReplyErrorModal,
  handleCloseModifyReplyErrorModal,
}: ModifyReplyErrorModalProps) {
  return (
    <Modal
      show={showModifyReplyErrorModal}
      onHide={handleCloseModifyReplyErrorModal}
      backdrop="static"
      keyboard={false}
    >
      <Alert variant="danger" className="m-0 p-0">
        ...
        <Modal.Footer className="border-0 pt-0 p-3">
          <Button
            ...
            onClick={handleCloseModifyReplyErrorModal}
          >
            Back
          </Button>
        </Modal.Footer>
