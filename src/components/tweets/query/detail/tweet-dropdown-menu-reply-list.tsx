...
export interface TweetDropdownMenuReplyListProps {
  replys: IReply[];
  handleShowReplyListModal: () => void;
}

export default function TweetDropdownMenuReplyList({
  replys,
  handleShowReplyListModal,
}: TweetDropdownMenuReplyListProps) {
  return (
    <Dropdown.Item
    ...
    >
      ...
      <span>Replys ({replys.length})</span>
    </Dropdown.Item>
  );
}
